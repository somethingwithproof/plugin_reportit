...
$rubrics = [
	__('Functions w/o parameters', 'reportit') => $calc_functions,
	__('Functions with parameters', 'reportit') => $calc_functions_params,
	__('Aliases', 'reportit') => $calc_functions_aliases,
	__('Operators', 'reportit') => $calc_operators,
	__('Parentheses', 'reportit') => $calc_parentheses,
	__('Variables', 'reportit') => $calc_variables,
	__('Data Query Variables', 'reportit') => '',
	__('Interim Results', 'reportit') => '',
];
