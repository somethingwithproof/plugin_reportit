...
function reportit_recreate_cache_tables()
{
	 ...
	 */
	$data = [];
	$data['columns'][] = ['name' => 'cache_id', 'type' => 'varchar(30)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'user_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'name', 'type' => 'varchar(128)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'enabled', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];

	/* status column */
	$data['columns'][] = ['name' => 'state', 'type' => 'tinyint(1)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'last_state', 'type' => 'timestamp', 'NULL' => true];

	/* archive specific columns */
	$data['columns'][] = ['name' => 'owner','type' => 'varchar(20)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'template_name', 'type' => 'varchar(64)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'data_template_alias', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];

	/* scheduling attributes */
	$data['columns'][] = ['name' => 'sched_type', 'unsigned' => true, 'type' => 'int(10)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'run_limit', 'unsigned' => true, 'type' => 'int(10)', 'NULL' => true, 'default' => '0'];
	$data['columns'][] = ['name' => 'start_at', 'type' => 'varchar(20)', 'NULL' => true, 'default' => ''];
	$data['columns'][] = ['name' => 'next_start', 'type' => 'timestamp', 'NULL' => false, 'default' => '0000-00-00 00:00:00'];
	$data['columns'][] = ['name' => 'recur_every', 'unsigned' => true, 'type' => 'int(10)', 'NULL' => true, 'default' => '1'];
	$data['columns'][] = ['name' => 'day_of_week', 'type' => 'varchar(45)', 'NULL' => true, 'default' => ''];
	$data['columns'][] = ['name' => 'month', 'type' => 'varchar(45)', 'NULL' => true, 'default' => ''];
	$data['columns'][] = ['name' => 'day_of_month', 'type' => 'varchar(45)', 'NULL' => true, 'default' => ''];
	$data['columns'][] = ['name' => 'monthly_week', 'type' => 'varchar(45)', 'NULL' => true, 'default' => ''];
	$data['columns'][] = ['name' => 'monthly_day', 'type' => 'varchar(45)', 'NULL' => true, 'default' => ''];
	...
	$data['columns'][] = ['name' => 'last_status', 'type' => 'varchar(128)', 'NULL' => false, 'default' => ''];

	/* reportit specific attributes */
	$data['columns'][] = ['name' => 'description', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'template_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'site_id', 'type' => 'int(11)', 'unsigned' => true, 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'host_template_id', 'type' => 'mediumint(8)', 'unsigned' => true,	'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'data_source_filter', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'preset_timespan', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'public', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'start_date', 'type' => 'date', 'NULL' => true];
	$data['columns'][] = ['name' => 'end_date', 'type' => 'date', 'NULL' => true];
	$data['columns'][] = ['name' => 'ds_description', 'type' => 'varchar(5000)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'rs_def', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'sp_def', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'sliding', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'present', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'autorrdlist', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'auto_email', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'email_subject', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'email_body', 'type' => 'varchar(1000)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'email_format', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	...
	$data['columns'][] = ['name' => 'subhead', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'graph_permission', 'type' => 'varchar(2)', 'NULL' => false, 'default' => 'on'];
	...
	$data['columns'][] = ['name' => 'id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'template_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'group_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'name', 'type' => 'varchar(128)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'abbreviation', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'calc_formula', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'unit', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'visible', 'type' => 'varchar(2)', 'NULL' => false, 'default' => 'on'];
	$data['columns'][] = ['name' => 'spanned', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'rounding', 'type' => 'tinyint(1)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'cf', 'type' => 'tinyint(1)', 'NULL' => false, 'default' => '1'];
	...
	$data['columns'][] = ['name' => 'input_type', 'type' => 'tinyint(1)', 'NULL' => false, 'default' => '0'];
...
function reportit_system_install()
{
	...
	*/
	...
	$data['columns'][] = ['name' => 'email_body', 'type' => 'varchar(1000)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'email_format', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'notify_list', 'type' => 'int(11)', 'unsigned' => true, 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'subhead', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'graph_permission', 'type' => 'varchar(2)', 'NULL' => false, 'default' => 'on'];
	$data['primary'] = 'id';
	$data['type'] = 'InnoDB';
	...
	*/
	$data = [];
	$data['columns'][] = ['name' => 'id', 'type' => 'mediumint(8)', 'NULL' => false, 'auto_increment' => true];
	$data['columns'][] = ['name' => 'name', 'type' => 'varchar(128)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'user_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'modified_by', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'author', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'version', 'type' => 'varchar(10)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'description', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'pre_filter', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'data_template_id', 'type' => 'mediumint(8)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'locked', 'type' => 'varchar(2)', 'NULL' => false, 'default' => 'on'];
	$data['columns'][] = ['name' => 'enabled', 'type' => 'varchar(2)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'export_folder', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['primary'] = 'id';
	$data['type'] = 'InnoDB';
	...
	*/
	$data = [];
	$data['columns'][] = ['name' => 'id', 'type' => 'int(11)', 'NULL' => false, 'auto_increment' => true];
	$data['columns'][] = ['name' => 'template_id', 'type' => 'mediumint(8)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'group_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'name', 'type' => 'varchar(128)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'abbreviation', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'calc_formula', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	...
	*/
	...
	$data['columns'][] = ['name' => 'id', 'type' => 'int(11)', 'NULL' => false, 'auto_increment' => true];
	$data['columns'][] = ['name' => 'template_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'report_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'variable_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'value', 'type' => 'float', 'NULL' => false, 'default' => '0'];
	$data['primary'] = 'id';
	$data['type'] = 'InnoDB';
	...
	*/
	...
	$data['columns'][] = ['name' => 'id', 'type' => 'int(11)', 'NULL' => false, 'default' => 0];
	$data['columns'][] = ['name' => 'description', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'start_day', 'type' => 'varchar(255)', 'NULL' => false, 'default' => 'Monday'];
	$data['columns'][] = ['name' => 'end_day', 'type' => 'varchar(255)', 'NULL' => false, 'default' => 'Sunday'];
	...
	$data['columns'][] = ['name' => 'timezone', 'type' => 'varchar(255)', 'NULL' => false, 'default' => 'GMT'];
	$data['primary'] = 'id';
	$data['type'] = 'InnoDB';
	...
	*/
	...
	$data['columns'][] = ['name' => 'id', 'type' => 'int(11)', 'NULL' => false, 'auto_increment' => true];
	$data['columns'][] = ['name' => 'report_id', 'type' => 'int(11)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'email', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'name', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['primary'] = 'id';
	$data['type'] = 'InnoDB';
	...
	*/
	...
	$data['columns'][] = ['name' => 'name', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'description', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'generic_group_id', 'type' => 'varchar(32)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'elements', 'type' => 'varchar(510)', 'NULL' => false, 'default' => ''];
	$data['primary'] = 'id';
	...
	*/
	...
	$data['columns'][] = ['name' => 'template_id', 'type' => 'mediumint(8)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'group_id', 'type' => 'mediumint(8)', 'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'data_template_id', 'type' => 'mediumint(8)', 'unsigned' => true,	'NULL' => false, 'default' => '0'];
	$data['columns'][] = ['name' => 'data_source_name', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'data_source_alias', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'data_source_title', 'type' => 'varchar(255)', 'NULL' => false, 'default' => ''];
	$data['columns'][] = ['name' => 'data_source_mp', 'type' => 'varchar(255)', 'NULL' => false, 'default' => '1'];
