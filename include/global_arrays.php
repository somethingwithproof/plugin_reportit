...
/* - Begin measurands - */
$measurand_type_specifier = [      //TODO update script: increase every value by one!
	0 => __('None', 'reportit'),
...
$settings_max_record_per_report = [
